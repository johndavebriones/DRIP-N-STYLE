...
$pageKey = in_array($currentPage, ['index.php']) ? 'index' :
           ...
           (in_array($currentPage, ['profile.php']) ? 'profile' : 'index')));
...
<nav class="navbar navbar-expand-lg navbar-dark shadow-sm">
  <div class="container">
    <a class="navbar-brand text-warning fw-bold" href="<?= ($currentPage === 'index.php') ? './index.php' : '../index.php' ?>">Drip N' Style</a>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      <ul class="navbar-nav align-items-center">
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
          ...
          <li class="nav-item">
            <a class="nav-link <?= ($currentPage === 'shop.php') ? 'active' : '' ?>" href="<?= $base['shop'] ?>">Shop</a>
          </li>
          <?php if ($pageKey !== 'index'): ?>
          <li class="nav-item">
            <a class="nav-link <?= ($currentPage === 'cart.php') ? 'active' : '' ?>" href="<?= $base['cart'] ?>">Cart</a>
          </li>
          <?php endif; ?>
